...
public interface ConcurrentMemoryStore {
	 ...
	 * 
	 * @throws IllegalArgumentException Si ya existe un valor asociado a la clave
	 */
	void store(String key, Item item) throws IllegalArgumentException;

	/**
	 * Actualiza los valores del Item asociado a key. La instancia de Item que queda
	 * almacenada no debe cambiar.
	 **/
